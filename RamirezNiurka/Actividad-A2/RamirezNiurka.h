...
int RamirezNiurka_comparar(){
	...
	cin>>nc_B;
	if(nc_A==nc_B) {
	cout<<"El valor de nc_A= "<<nc_A<<" es igual a nc_B "<<nc_B<<endl;
	}else{
		if(nc_A<nc_B){

	cout<<"El valor de nc_A=" <<nc_A<<" es menor a nc_B="<<nc_B<<endl;
                }else{
        cout<<"El valor de nc_B=" <<nc_B<<" es menor a nc_A="<<nc_A<<endl<<endl;
                }
                }
cout<<"//================================================="<<endl;
cout<<"//=======Nombre de programa: comparar"<<endl;
cout<<"//====Archivo: RamirezNiurka_comparar.cpp"<<endl;
cout<<"//====Autor: Ramirez Niurka "<<endl;
cout<<"//====Fecha de elaboracion: 01-05-2022"<<endl;
cout<<"//====Fecha de ultima actualizacion: 26-05-2022"<<endl;
cout<<"//================================================="<<endl;
	return 0;
}
